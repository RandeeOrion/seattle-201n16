...
function sumArray(sumAr) { //eslint-disable-line
    var sum1 = sum(sumAr[0], sumAr[1]);
    var sum2 = sum(sum1[0], sumAr[2]);
    //console.log(sum2);

    var stringY = [sum2[0], `${testArray} was passed in as an array of numbers, and ${sum2[0]} is their sum.`];
    return stringY;
}
...
// Write your code here
function multiplyArray(multAr) { //eslint-disable-line
    var mult1 = multiply(multAr[0], multAr[1]);
    var mult2 = multiply(mult1[0], multAr[2]);
    //console.log(sum2);

    var stringY2 = [mult2[0], `The numbers ${testArray} have a product of ${mult2[0]}.`];
    return stringY2;
}
